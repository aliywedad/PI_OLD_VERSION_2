...
class Api {
  ...
  static const updateVillageInfo = ip+"village_info/";
  static const commin = ip+"list_commune/";
  static const village = ip+"list_Village/";
  static const forms = ip+"forms/";
  static const questions = ip+"list_questions/";
  // static const forms = "";
  static const getforms = ip+"Get forms/";
  static const uesrs = ip+"list_users/";
  static const inserer_donnees = ip+"inserer_donnees/";
