 ...
 import { loggedInCookie, UserLoggedInCookie, Logout  } from './Cookies';
...
import profile from '../imeges/profile.png'
 ...
 export default function NavBarDA({ toggle, setToggle,SetRender,Render }) {
        ...
        <Navbar expand="lg" className="whitesmoke  border-1 text-black p-0" fixed="top"> {/* Correction de l'orthographe */}
          <Container fluid>
            ...
            <Navbar.Collapse id="navbarScroll">
              ...
              <Nav
                className="me-auto pl-20 my-2  my-lg-0   d-flex"
                // style={{ maxHeight: '100px' }}
               >
                <Nav.Link>
                <li onClick={()=>{SetRender("wilaya")}}>wilaya</li>
                </Nav.Link>
                <Nav.Link>
                <li onClick={()=>{SetRender("moghataa")}}>moghataa</li>
                </Nav.Link>

                <Nav.Link>
                <li onClick={()=>{SetRender("commun")}}>commun</li>
                </Nav.Link>
                <Nav.Link>
                <li onClick={()=>{SetRender("village")}}>village</li>
                </Nav.Link>
